...
from src.utils.model_conversion_utils import convert_model, fix_thresholds, convert_model_uint8
...
if __name__ == '__main__':
    ...
    for OBJECT_ID in OBJECT_IDS:
        ...
        MODELS_DIR  = f'test_4bits_uint8/models/object_{OBJECT_ID}/decision_tree_{SPLIT}/quantization'
        ...
        for num_bits in [4]:
            ...
            best_model = fix_thresholds(model=best_model)

            convert_model(best_model, f"{final_dir}", use_dtype='uint8_t')
